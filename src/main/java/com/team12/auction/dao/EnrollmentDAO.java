...
public class EnrollmentDAO {
	...
	public List<DepartmentEnrollmentStat> getEnrollmentByDepartment(String department) throws SQLException {
		String sql = "SELECT s.section_id, " + "c.course_name, " + "s.capacity AS section_capacity, "
				+ "COUNT(e.student_id) AS enrolled_count " + "FROM Section s "
				+ "JOIN Course c ON s.course_id = c.course_id "
				+ "LEFT JOIN Enrollment e ON e.section_id = s.section_id " + "WHERE c.department = ? "
				+ "GROUP BY s.section_id, c.course_name, s.capacity " + "ORDER BY c.course_name, s.section_id";
