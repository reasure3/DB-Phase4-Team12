...
public class Course {
	...
	public String toString() {
		return "Course{" + "courseId='" + courseId + '\'' + ", courseName='" + courseName + '\'' + ", department='"
				+ department + '\'' + ", credits=" + credits + ", capacity=" + capacity + ", semester='" + semester
				+ '\'' + ", year=" + year + '}';
	}
	...
	public boolean equals(Object o) {
		if (this == o)
			return true; // 같은 참조면 true
		if (o == null || getClass() != o.getClass())
			return false; // null이거나 다른 클래스면 false
